...
<body>
	<div class="content">
		<p align="left" style="font-size: 18px;color: blue;">申诉管理:</p>
		<center>
			<a class="pure-button pure-button-primary"
				href="<html:rewrite action="/control/appeal/manage"/>?method=addUI">添加</a>
			<a class="pure-button pure-button-primary"
				href="<html:rewrite action="/control/appeal/manage"/>?method=queryUI">查询</a>
		</center>
		<br />
		<html:form action="/control/appeal/list" method="post">
				...
				<tbody>
					<c:forEach items="${pageView.records}" var="entry">
						<tr>
							...
							<td><a
								onclick="javascript: if(window.confirm('是否删除')) window.location='<html:rewrite action='/control/appeal/manage'/>?method=delete&id=${entry.id}';">删除</a>
							</td>
							<td><a
								href="<html:rewrite action="/control/appeal/manage"/>?method=editUI&id=${entry.id}">修改</a>
							</td>
						</tr>
					</c:forEach>
