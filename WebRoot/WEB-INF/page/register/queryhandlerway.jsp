...
<html:form action="/control/register/manage" styleClass="pure-form pure-form-aligned" method="post"  onsubmit="return checkfm(this)">
<input type="hidden" name="method" value="query">
<html:hidden property="query" value="true"/>
  <table  width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
  <tr bgcolor="6f8ac4"><td colspan="2"> <font color="#FFFFFF">以处理方式查询检举控告类表：</font></td>
  <tr bgcolor="f5f5f5"> 
  ...
  <tr bgcolor="f5f5f5"> 
    ...
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">来源文号：</div></td>
      <td width="78%"> <html:text property="sourcenumber" size="50" maxlength="40"/>
         </td>
    </tr>
  <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">转办文号：</div></td>
      <td width="78%"> <html:text property="handlernumber" size="50" maxlength="40"/>
         </td>
    </tr>
  <tr bgcolor="f5f5f5"> 
  ...
  <tr bgcolor="f5f5f5">
      <td width="22%" > <div align="right">问题类型：</div></td>
  ...
  <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">处置方式：</div></td>
      <td width="78%"> 
  ...
  <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">处置次数：</div></td>
      <td width="78%"> 
<select name="ispunish">
    ...
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">主要问题线索：</div></td>
      <td width="78%"> <html:text property="mainthread" size="50" maxlength="40"/>
         </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
