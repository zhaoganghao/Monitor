...
<body>
	...
	<html:form styleClass="pure-form pure-form-aligned"
		...
		<html:hidden property="relationid1" />
		<html:hidden property="relationid2" />
		<html:hidden property="relationid3" />
		<fieldset>
			...
			<div class="pure-u-10-24">
				<fieldset>
					<div class="pure-control-group">
						...
						<html:text property="indexcode" onblur="TestLen(this,7)"  /><font color="#FF0000">*</font>
					</div>
					<div class="pure-control-group">
