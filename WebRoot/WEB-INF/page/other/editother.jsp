...
<html:form action="/control/other/manage" enctype="multipart/form-data" method="post">
<input type="hidden" name="method" value="edit">
<html:hidden property="id"/>
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4"> 
      <td colspan="2" ><font color="#FFFFFF">登记业务范围外的业务：</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
	...
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">涉及各类问题 ：</div></td>
      <td width="75%"> 
	...
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">处理去向 ：</div></td>
      <td width="75%"> 
