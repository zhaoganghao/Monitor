...
<html:form action="/control/nocontent/list" styleClass="pure-form pure-form-aligned" method="post"  onsubmit="return checkfm(this)">
<html:hidden property="query" value="true"/>
  <table  width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
  <tr bgcolor="6f8ac4"><td colspan="2"> <font color="#FFFFFF">无实质内容查询：</font></td>
  <tr bgcolor="f5f5f5"> 
